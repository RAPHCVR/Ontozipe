    ...
    return (
        <div className="container mx-auto max-w-5xl space-y-8 px-4 py-12">
                ...
                <div className="flex flex-col gap-4 rounded-3xl bg-white/95 p-6 text-slate-800 dark:bg-slate-900/90 dark:text-slate-100 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-300">
                            Gérez vos informations personnelles et sécurisez votre compte en quelques clics.
                        </p>
                    </div>
                    <div className="flex items-center gap-3 rounded-2xl bg-indigo-50 px-4 py-2 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-200">
                        ...
                        <span className="text-sm font-medium">{user?.email ?? "Utilisateur anonyme"}</span>
                    </div>
                </div>
            </header>
            ...
            <section className={sectionClass}>
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-100">Informations générales</h2>
                        <p className="text-sm text-slate-500 dark:text-slate-300">
            ...
            <section className={sectionClass}>
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-100">Sécurité du compte</h2>
                        <p className="text-sm text-slate-500 dark:text-slate-300">
                    ...
                    <form className="space-y-5" onSubmit={handlePasswordSubmit}>
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="space-y-1">
                                <label className="text-sm font-medium text-slate-700 dark:text-slate-200">Ancien mot de passe</label>
                                <input
                                    type="password"
                                    className={inputClass}
                                    value={oldPassword}
                        ...
                        <div className="rounded-2xl border border-indigo-100/80 bg-white/70 px-4 py-3 text-sm text-slate-600 shadow-inner dark:border-slate-700 dark:bg-slate-800/60 dark:text-slate-300">
                            <p className="font-medium text-slate-700 dark:text-slate-200">Votre mot de passe doit contenir au moins&nbsp;:</p>
