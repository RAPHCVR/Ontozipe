...
const extractSlug = (iri: string) => iri.split(/[#/]/).filter(Boolean).pop() || iri;
...
export default function HomePage() {
    ...
    const orderedOntologies = useMemo(() => {
        ...
        list.sort((a, b) => {
            if (prioritizeFavorites) {
                const favDelta = Number(favorites.has(b.iri)) - Number(favorites.has(a.iri));
    ...
    if (ontologiesQuery.isError) {
        return (
            <div className="page-state">
                <i className="fas fa-exclamation-triangle page-state__icon" aria-hidden />
                ...
                <div className="app-container home__hero-inner">
                    <div className="home__welcome">
                        ...
                        <p className="home__subtitle">
                            Accédez en un clic à l’ensemble de vos connaissances, partagez-les avec
                            vos équipes et explorez-les grâce à des visualisations immersives.
                        </p>
                ...
                <div className="app-container home__content-inner">
                    <header className="home__section-header">
                        <div>
                            ...
                            <p className="home__section-subtitle">
                                Sélectionnez une ontologie pour l’ouvrir ou démarrez un espace de travail
                                collaboratif instantané.
                            </p>
                        </div>
                    ...
                    {ontos.length === 0 && (
                        <div className="home__empty">
                            ...
                            <p>
                                Commencez par importer une ontologie ou demandez à votre équipe de vous
                                en partager une.
                            </p>
                            {rolesLoaded && isSuperAdmin && (
                                <button
