...
<<<<<<< Updated upstream
- Adopte un ton amical. Réponds typiquement en 5–7 lignes max.
...
=======
- Tu peux appeler search_from_uri avec l’URI complète ou simplement le suffixe/handle d’une entité (le service reconstruira l’URI complète).
